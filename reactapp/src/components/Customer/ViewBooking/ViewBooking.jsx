...
//           {filterEvents.map((event, index) => (
//             <div key={index} className="event-card" onClick={() => openModal(event)}>
//               <div className="event-details-2">
//                 <img src={event.eventImg} alt={event.eventName} className="event-image" />
//                 <h3>{event.eventName}</h3>
//                 <p>{convertTo12HourFormat(event.eventTime)}</p>
...
//                   <img src={selectedEvent.eventImg} alt={selectedEvent.eventName} className="modal-event-image" />
//                   <div className="modal-event-info">
//                     <h2>{selectedEvent.eventName}</h2>
//                     <p>{convertTo12HourFormat(selectedEvent.eventTime)}</p>
//                     <p>{selectedEvent.eventDate}</p>
//                     <p>₹{selectedEvent.eventCost}</p>
