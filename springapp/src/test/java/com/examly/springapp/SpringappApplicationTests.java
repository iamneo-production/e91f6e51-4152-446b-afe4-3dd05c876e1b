...
class SpringappApplicationTests {
	...
	@Test
	@Transactional
    public void BE_spring_add_theme() throws Exception {
	...
	@Test
	@Transactional
    public void BE_spring_get_theme() throws Exception {
	...
	@Test
	@Transactional
    public void BE_spring_update_theme() throws Exception {
        String newTheme = "{\"themeId\":\"01\",\"themeName\":\"ABC\",\"themeImageURL\":\"ABC.png\",\"themeDescription\":\"attractive\",\"themePhotographer\":\"XYZ\",\"themeVideographer\":\"PQR\",\"ThemeReturnGift\":\"yes\",\"ThemeCost\":\"100000\"}";
	...
	@Test
	@Transactional
    public void BE_spring_add_foodMenu() throws Exception {
	...
	@Test
	@Transactional
    public void BE_spring_update_foodMenu() throws Exception {
        String newFoodMenu = "{\"foodMenuID\":\"01\",\"foodMenuType\":\"ABC\",\"foodMenuItems\":\"abcd\",\"foodMenuCost\":\"25000\"}";
